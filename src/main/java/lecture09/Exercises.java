...
public class Exercises {
    public static void main(String[] args) {
        Person person = new Person("Dimitar", "male", "orthodox", "Bulgarian", true, "Bulgarian", "Bulgaria", 8103245060L);
        Italian italian = new Italian("Francesco", "male", "catholic", true, "Italy", 7605108945L);
        Bulgarian bulgarian = new Bulgarian("Ivanka", "female", "orthodox", true, "Bulgaria", 9112239583L);
        American american = new American("John", "male", "catholic", true, "USA", 6811125584L);
