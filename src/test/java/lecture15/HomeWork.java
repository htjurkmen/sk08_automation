...
public class HomeWork {
    ...
    void dynamicControl() {
        ...
        longWait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("loading"))));
    ...
    private void closeModalIfAppears(WebDriver driver, String modalLocator) {
        ...
        try {
            ...
            smallWait.until(ExpectedConditions.visibilityOfElementLocated(modalLoc));
